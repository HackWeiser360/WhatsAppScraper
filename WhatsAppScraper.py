...
def main():
   ...
   |__/|__/_/ /_/\__,_/\__//____/\___/_/   \__,_/ .___/\___/_/     
	...
	if len(sys.argv) >= 2:
		if 'u' in sys.argv[1] or '-u' in sys.argv[1]:
			...
			try:
				txt = urllib.request.urlopen("https://github.com/HackWeiser360/WhatsAppScraper/raw/master/WhatsAppScraper.py").read()
   ...
   4> Update WhatsAppScraper
	...
	if inp != 4:
		...
		f = open(SAVE, 'w')
		f.write("Group Links Generated By WhatScrapper \nGet it at https://github.com/HackWeiser360/WhatsAppScraper\r\n")
		f.close()
	...
	if inp == 1:	
		...
		try: 
			...
			f.write(txt)
			f.close()
			print("[$] WhatsAppScraper updated successfully")
			print("[i] Run " + sys.argv[0] + " Again..")
		except:
			print("[!] Update Failed !!!     ")
		exit()
